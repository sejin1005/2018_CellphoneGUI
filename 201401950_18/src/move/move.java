...
public class move extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(psmile, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(lbl, javax.swing.GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE))
                .addGap(18, 18, 18)
    ...
    private void imgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imgActionPerformed
        JFileChooser imgc = new JFileChooser(); //이미지 선택
        imgc.showOpenDialog(null);
        String path = imgc.getSelectedFile().getPath();
        ImageIcon icon = new ImageIcon(path);//이미지 읽기
        Image i = icon.getImage(); //Image 클래스에 객체 이미지를 생성
        //패널에 표시
        Graphics2D g2 = (Graphics2D)psmile.getGraphics(); //객체 이미지를 패널에 표시함.,(Graphics2D)로 형변환 시킴.
        g2.drawImage(i,0,0,psmile.getWidth(),psmile.getHeight(),imgc); //(이미지클래스의 객체,패널 전체시작x,패널 전체시작y, pnl폭,pnl높이,파일)
